           ...
           <div class="table" cellpadding="0">
                ...
                <div class="div-table">
                    <div class="head">
                        ...
                        <div class="th"><h4>Telephone</h4></div>
                    ...
                    <div class="body">
                        @foreach($fournisseurs as $fournisseur)
                            <div class="ligne">
                                <div class="td"><h4>{{$fournisseur->id}}</h4></div>
                                <div class="td"><h4>{{$fournisseur->nom}}</h4></div>
                                <div class="td"><h4>{{$fournisseur->email}}</h4></div>
                                <div class="td"><h4>{{$fournisseur->numerotel}}</h4></div>
                                <div class="td"><h4>{{$fournisseur->adresse}}</h4></div>
