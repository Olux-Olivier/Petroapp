           ...
           <div class="table" cellpadding="0">
                ...
                <div class="div-table">
                    <div class="head" style="grid-template-columns:repeat(8,1fr)">
                        ...
                        <div class="th"><h4>Article cmd</h4></div>
                        <div class="th"><h4>Quantite en L</h4></div>
                        <div class="th"><h4>Prix unitair</h4></div>
                        <div class="th"><h4>Prix total</h4></div>
                        <div class="th"><h4>Nom frs</h4></div>
                    ...
                    <div class="body" >
                        @foreach($cmdfournisseurs as $cmdfournisseur)
                            <div class="ligne" style="grid-template-columns:repeat(8,1fr)">
                                <div class="td"><h4>{{$cmdfournisseur->id}}</h4></div>
                                <div class="td"><h4>{{$cmdfournisseur->article_id}}</h4></div>
                                <div class="td"><h4>{{$cmdfournisseur->qte}}</h4></div>
                                <div class="td"><h4>{{$cmdfournisseur->prix}}</h4></div>
                                @php
                                    $prix_total = $cmdfournisseur->prix * $cmdfournisseur->qte;
                                @endphp
                                <div class="td"><h4>{{$prix_total}}</h4></div>
                                <div class="td"><h4>{{$cmdfournisseur->fournisseur_id}}</h4></div>
                                <div class="td"><h4>
