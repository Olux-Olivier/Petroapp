    ...
    <div class="container container-form">
        ...
        <div class="content-body">
           ...
           <div class="table" cellpadding="0">
                <h3>Liste des pompistes</h3>
                <div class="div-table">
                    <div class="head">
                        <div class="th"><h4>id</h4></div>
                        <div class="th"><h4>Nom</h4></div>
                        <div class="th"><h4>Postnom</h4></div>
                        <div class="th"><h4>Prenom</h4></div>
                        <div class="th"><h4>Contact</h4></div>
                        <div class="th"><h4>Actions</h4></div>
                    </div>
                    <div class="body">
                        @foreach($pompistes as $pompiste)
                            <div class="ligne">
                                <div class="td"><h4>{{$pompiste->id}}</h4></div>
                                <div class="td"><h4>{{$pompiste->nom}}</h4></div>
                                <div class="td"><h4>{{$pompiste->postnom}}</h4></div>
                                <div class="td"><h4>{{$pompiste->prenom}}</h4></div>
                                <div class="td"><h4>{{$pompiste->contact}}</h4></div>
