    ...
    <div class="container container-form">
        ...
        <div class="content-body">
           ...
           <div class="table" cellpadding="0">
                ...
                <div class="div-table">
                    <div class="head" style="grid-template-columns:repeat(3,1fr)">
                    ...
                    <div class="body">
                        @foreach($articles as $article)
                            <div class="ligne" style="grid-template-columns:repeat(3,1fr)">
                                <div class="td"><h4>{{$article->id}}</h4></div>
                                <div class="td"><h4>{{$article->nom}}</h4></div>
